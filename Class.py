...
class Class:
    def __init__(self, file_name, class_name, package, constructor=[], annotations=[], dependencies=[], methods=[], variables=[], implements=[],interfaces=[], method_invocations=[], extends=[], imports=[], is_interface = False):
    ...
    def extract_info(self, class_info):
        ...
        self.dependencies = class_info['dependencies'] if "dependencies" in class_info.keys() else self.dependencies
        ...
        #verificar depois extends, implements e interfaces
        ...
        self.interfaces = class_info['myInterfaces'] if "myInterfaces" in class_info.keys() else self.interfaces

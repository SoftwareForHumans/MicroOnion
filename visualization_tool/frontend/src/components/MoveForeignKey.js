    ...
    <Row className="py-2 blue-text">
      ...
      <div className="intermediate-text">
        ...
        <p className="mt-3" style={{ fontSize: "0.8rem" }}>
          ...
          suitable for your system, check the catalogue to find out how to
          implement it. Additionally, you may need to remove code annotations when using specific programming languages, frameworks or ORMs that use it.
        </p>
      </div>
    </Row>
  );
